...
def main(opt, save_animation=False):
    ...
    opt['datasets']['train']['dataroot'] = './adversarial_example'
    opt['datasets']['train']['dataset_type'] = 'ad_example'
    opt['datasets']['test']['dataroot'] = './adversarial_example'
    opt['datasets']['test']['dataset_type'] = 'ad_example'

    # print('opt:',opt['datasets']['train'])
    # print('opt:',opt)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task', type=str, default='predict_1_ae', help='Experiment name.')
    parser.add_argument('--protocol', type=str, default='1' ,choices=['1', '2', '3', 'real'], help='Protocol.')
    parser.add_argument('--checkpoint', type=str, default='./checkpoint/AvatarJLM-p3-100k.pth', help='Trained model weights.')
    parser.add_argument('--vis', default= True, action="store_true", help='Save animation.')
