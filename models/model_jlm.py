...
class ModelAvatarJLM(ModelBase):
    ...
    def feed_data(self, data, test=False):
        ...
        print('[feed_data() in model_jlm.py] self.input_signal.shape:', self.input_signal.shape)
        ...
        print('[feed_data() in model_jlm.py] batch:', batch)
        print('[feed_data() in model_jlm.py] seq_len:', seq_len)
